        ...
        <div class="item w-100" style=";padding: 20px">
            <div>
                <div style="font-size: 15px;margin-top: 8px;">
                    ...
                    {{prop.attrs.finish[0].description}}
                </div>
                <div v-if="!attrs.finish[0].name" style="font-size: 15px;margin-right: 35px;margin-top: 10px;">
                ...
                <span class="data-left" style="right: unset; left: 17px; top: 17px;">
                    {{prop.attrs.finish[0].created_at_fa}}
                </span>
                <div class="mt-4 order-detail__item flex-wrap justify-content-between"
                     style="z-index: 6;position: relative">
                    <div class="col-12">
                        <div class="">
                            <a class="btn py-3 btn--primary outline w-100" target="_blank" :href="prop.attrs.finish[0].value">
                                مشاهده سایت
                            </a>
                        </div>
...
const page = ref(0)
const form = useForm({
    info:prop.attrs.finish?prop.attrs.finish[0].name:null,
    attr_id:prop.attrs.finish[0].id,
    type:'finish'
})
